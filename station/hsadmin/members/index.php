...
<div id="container">
		...
		<div id="content">
		  ...
		  <?
			...
			<p><a href="add.php">add a member</a>?</p>
			...
			<td class="memberhead">Deck</td>
			<td class="memberhead">Sign</td>
			<td class="memberhead">update</td>
			<td class="memberhead">delete</td>
			</tr>
			...
			<td class="membertr"><? echo "$collecting"; ?></a></td>
			<td class="membertr"><? echo "$birthday"; ?></td>
			<td class="membertr"><a href=update.php?id=<? echo "$id"; ?>>Update</a></td>
			<td class="membertr"><a href=delete.php?id=<? echo "$id"; ?>>Delete</a></td>
			</tr>
			<?
			} // end if (for level)
			++$i;
